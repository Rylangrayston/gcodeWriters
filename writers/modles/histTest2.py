...
for layer in range(0,int(layers), step):
	...
	shift2 = ((layer - preTestLayers)*stepOverRate)
	corection = -((layer - preTestLayers) * correctionRate)
	...
	if layer > preTestLayers:
		...
		file.write("G1 " + drawSpeed +"X" +str( corection) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str( corection) + " Y" + str(0) + laserOn + " \n")
