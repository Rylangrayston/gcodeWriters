...
for layer in range(0,int(layers), step):
	...
	shift2 = ((layer - noCorrectionLayers)*stepOverRate)
	

	if layer < preTestLayers:
	...
	if layer  > preTestLayers and layer < noCorrectionLayers :
		file.write("G1 " + "Z" + str(layer/1.0) + " \n") # go up a layer
		file.write("G1 " + drawSpeed +"X" +str(stack1Pos) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str(stack1Pos) + " Y" + str(0) + laserOn + " \n")
		file.write("G1 " + drawSpeed +"X" +str(0) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str(0) + " Y" + str(0) + laserOn + " \n")

	if layer > noCorrectionLayers:
		file.write("G1 " + "Z" + str(layer/1.0) + " \n") # go up a layer
		file.write("G1 " + drawSpeed +"X" +str(stack1Pos) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str(stack1Pos) + " Y" + str(0) + laserOn + " \n")

		file.write("G1 " + drawSpeed +"X" +str( shift2) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str( shift2) + " Y" + str(0) + laserOn + " \n")

		file.write("G1 " + drawSpeed +"X" +str(stack3Pos) + " Y" + str(stackWidth) + laserOff + " \n")
		file.write("G1 " + drawSpeed +"X" +str(stack3Pos) + " Y" + str(0) + laserOn + " \n")
